      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          <div>
            ...
            <p>Simon Ugor built apps WhatTheRocket, Drop That Box, Planets Dodge, Hack The Game and Drop The Basketball as Free apps. This SERVICE is provided by Simon Ugor at no cost and is intended for use as is.
